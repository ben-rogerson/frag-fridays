...
- **Secondary (fullscreen / `.fs`):** small bevel chrome buttons - navy gradient (#2c4278 → #1d2f5c) or translucent navy, Phosphor White text/icon at 0.62rem uppercase, inline 2px-stroke SVG icons, hover brightens via filter, same Hot Acid focus outline.
