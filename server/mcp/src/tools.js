...
const ROOT = '/opt/cs16'
const MOD_DIRS = ['gg', 'dm', 'zp', 'kz'] // per-mod compose projects; vanilla lives in ROOT
...
export function registerTools(server) {
  ...
  server.registerTool(
    'swap_mod',
    {
      title: 'Swap game mod',
      description:
        'DESTRUCTIVE: swaps the running mod (vanilla/gg/dm/kz/zp). DROPS ALL ' +
      ...
      inputSchema: z.object({
        mod: z.enum(['vanilla', 'gg', 'dm', 'kz', 'zp']),
